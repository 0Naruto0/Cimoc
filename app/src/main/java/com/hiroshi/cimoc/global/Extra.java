...
/**
 * Created by Hiroshi on 2016/12/25.
 */
...
public class Extra {
    ...
    public static final String EXTRA_SOURCE_ID = "cimoc.intent.extra.EXTRA_SOURCE_ID";
    public static final String EXTRA_REMOTE_ID = "cimoc.intent.extra.EXTRA_REMOTE_ID";
